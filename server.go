...
func (kv *KVRaft) Msg(ctx context.Context, message raftpb.Message) error {
	...
	log.Println("[MSG]: IM:", kv.me, " ctx:", ctx, " message:", message)
	kv.raftNode.raft.Step(ctx, message)
	return nil
}
